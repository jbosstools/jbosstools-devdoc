...
** link:building/build_checks.adoc[Build-time baseline and maven enforcer checks]
...
** link:building/build_checks.adoc[Why is my build failing due to a baseline or enforcer check?]
...
*** link:building/build_checks.adoc#Baseline[Baseline version checks]
