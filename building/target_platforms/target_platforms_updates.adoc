...
* `mvn -U org.jboss.tools.tycho-plugins:target-platform-utils:1.0.0-SNAPSHOT:fix-versions -DgroupId=org.jboss.tools.tycho-plugins -DartifactId=target-platform-utils -Dversion=1.0.0-SNAPSHOT -Dpackaging=jar -DtargetFile=/path/to/jbosstools/multiple/jbosstools-multiple.target`
