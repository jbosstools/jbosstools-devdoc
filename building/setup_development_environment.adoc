...
Now that you're all done here, you'll want to learn all about target platforms. Please go back to link:../README.adoc[the index] to move forward with setting up your environment. 
