...
That unfortunately often lead to time wasted because either filters were not visible or queries were not defined the same way and
issues were missed.
...
These filter give a stable URL, will always track the latest 'maintenance', 'master', 'frozen' and what is 'next' without having
...
| https://issues.jboss.org/issues/?filter=12323075[ds_next_maint_unresolved] | unresolved work for next maintenance| filter='ds_next_maint' and filter='ds_unresolved'
...
| https://issues.jboss.org/issues/?filter=12323077[ds_my_next_maint_unresolved] | my unresolved work for next maintenance| filter='ds_mystuff' and filter='ds_next_maint' and filter='ds_unresolved'
